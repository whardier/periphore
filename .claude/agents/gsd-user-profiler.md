...
<reference>
@/Users/spencersr/src/whardier/periphore/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/spencersr/src/whardier/periphore/.claude/get-shit-done/references/user-profiling.md` to load:
