...
- **Global scope**: `/Users/spencersr/src/github/whardier/periphore/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/spencersr/src/github/whardier/periphore/.claude/notes/`)
...
2. Glob `/Users/spencersr/src/github/whardier/periphore/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/spencersr/src/github/whardier/periphore/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/spencersr/src/github/whardier/periphore/.claude/notes/` — works in any directory
