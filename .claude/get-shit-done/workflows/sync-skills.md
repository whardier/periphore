...
INSTALL_JS_GLOBAL="/Users/spencersr/src/github/whardier/periphore/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/spencersr/src/github/whardier/periphore/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
