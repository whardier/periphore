...
```markdown
Read /Users/spencersr/src/github/whardier/periphore/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/spencersr/src/github/whardier/periphore/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/spencersr/src/github/whardier/periphore/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/spencersr/src/github/whardier/periphore/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/spencersr/src/github/whardier/periphore/.claude/agents/gsd-eval-planner.md for instructions.
